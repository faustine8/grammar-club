...
这个句子的主部是 I 这个代词当主语。述部最重要的是 got up 这个**短语动词（phrasal verb）**。所谓短语，指的是两个以上的单词放在一起、构成一个意义单元（要合在一起解释）。像 get 这个动词，本身并没有「起床」的意思，必须和 up 这个介副词（看起来像介词， 但后面却没有宾语，故而是直接当副词使用）合在一起才是「起床」，所以应该把 get up 当作一个短语动词看待。像 get up 这种动作同样也可以独力完成，属于不及物动词（不需要 宾语）。后面的 rather late this morning 整个都是时间副词短语，修饰动词 got up 的时间，是可有可无的修饰语。
...
第一个宾语（对象）的位置空缺，句型会自动转变成 S + V + O。这时如果还要交代「给的对象」，已经没有地方可放，就得加个介词 to、制造出介词短语 to him 来表示（这个介词短语当副词使用、修饰动词 gave）。再看一个例子：

<u>I</u> <u>teach</u> <u>my son</u> <u>English</u>.
S V O O
（我教我儿子学英文。）

动词 teach 有两个宾语，第一个宾语 my son 是教的「对象」、第二个宾语 English 是教给他的「东西」。如果第一个宾语的位置从缺，那么句型就会变成 S + V +
O。如果后面还要交代「对象」的话就得动用介词短语来交代，如下：
...
宾语补语（S + V + O + C）的句型也有一个很简单的检验方式：把宾语和补语拿出来、中间加个 be 动词，如果可以构造出一个 S + V + C 的句型而且意思差不多，那么它就是宾语补语的句型。

下面这些例子，画底线部分分别是宾语（O）与补语（C）。请读者试试看，拿宾语出来当主语、中间加个 be 动词，后面的补语就变成主语补语。结果将是上一节列出的那些 S + V + C 的句子。
...
英文单句的五种基本句型，以句中包含的主要元素数目来区分，可以分成两个主要元素（S + V）、三个主要元素（S + V + O 与 S + V + C）、以及四个主要元素（S + V + O + O 与 S + V + O + C）等三种类型。如果一个句子一时之间看不出来是哪一种句型，可以先把可有可无的修饰语如介词短语等排除、看看剩下有几个主要元素，然后再来分辨。以下分别举例说明。
...
这也是三个元素的句型。主语是名词短语 the cat，动词是 looked，后面的形容词 elegant 是第三个元素。三个元素的句型只有 S + V + O 和 S + V + C 这两种选择，但是宾语必须是名词类，形容词 elegant 不能当宾语。所以，elegant 就只有一个可能：是补语。而检验主语补语的方式就是把动词换成 be 动词试试看：The cat was elegant.意思和原句差不多，所以可以确定原句是 S + V + C 的句型，如下。

<u>The cat</u> <u>looked</u> <u>elegant</u>.
S V C

_**如果在主语、动词后面还有个形容词，这个形容词应该是主语补语，句型是 S + V + C。如果在主语、动词后面还有个名词，这个名词不是宾语就是补语，可以把动词改为 be 动词来检验：意思不变的话就是 S + V + C，否则就是 S + V + O。**_
...
这个句子有四个元素：主语 the man、动词 fed、宾语 the cat，第四个元素是名词短语 canned food。而四个元素的句型只有 S + V + O + C 和 S + V + O + O 这两种选择，第四个元素不是补语就是另一个宾语。是不是宾语补语，检验方式是在宾语和补语中间加个 be 动词看看通不通：the cat was canned food 这个句子显然不通，那么第四个元素就只剩一种可能：是另一个宾语，如下：
...
这也是四个元素的句型，第四个元素 Fatty 是个专有名词。它是补语还是第二个宾语？可以在中间加个 be 动词来检验：The cat was Fatty.，意思和原句差不多，所以 Fatty 就是宾语补语，如下：

<u>The man</u> <u>called</u> <u>the cat</u> <u>“Fatty”</u>.
S V O C

_**如果在主语、动词、宾语后面还有个形容词，这个形容词应该是宾语补语，句型是 S + V + O + C。如果在主语、动词、宾语后面还有个名词，这个名词可能是第二个宾语、也可能是宾语补语。可以把第三、第四个元素拿出来、中间加个 be 动词来检验：意思相同的话就是 S + V + O + C，否则就是 S + V + O + O 的句型。**_


::: tip 思考
**问题 1：当 `S + V + O` 后面又出现一个名词时，能否根据动词具有“给予、传递”意义，直接判断为 `S + V + O + O`？**

**答案：**
不能只根据动词的意义判断。如果一个动词能够进入双宾语结构，并且后面的两个名词分别表示**接受者或受益者**和**被给予、传递或提供的事物**，句型才是 `S + V + O + O`。

例如：

> She gave me a book.

`me`：接受者；`a book`：被给予的事物。

---

**问题 2：一个动词什么时候能够进入双宾语结构？**

**答案：**
动词能否进入双宾语结构，不仅取决于它是否具有“给予、传递”等意义，还取决于这个动词本身是否允许这种句法结构，这属于动词的**配价或句型许可**。
...
`give` 允许双宾语结构，而 `explain` 通常不允许，必须说：

> She explained the problem to me.

---

**一句话总结：“给予类”语义只是判断双宾语结构的线索；能否真正使用 `SVOO`，最终取决于该动词是否允许双宾语句型。**
:::
